...
from scripts.notion.notion_py.collection import CollectionRowBlock, CollectionView
from scripts.notion.notion_py.block import DividerBlock
    ...
    def __init__(self, block):
        ...
        if isinstance(block, CollectionRowBlock):
            ...
            dict.__init__(
                self,
                **{
                    "collection_id": block.parent.id.replace("-", ""),
                    "view_id": block.id.replace("-", ""),
                    "collection_title": block.parent.title,
                    "view_title": block.name,
                }
            )
